...
<title>Insert title here</title>
  ...
  <link href="css/feed-cards.css" rel="stylesheet" >
</head>
<body>
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="SvFeedPublicacoes" class="nav-link px-2 link-secondary">Feed de Publicações</a></li>
        ...
        %>
                      ...
                      <div class="card">
                          <div class=" justify-content-between p-2 px-3">
                              <div class=" flex-row align-items-center"> <img src="img/perfil.png" width="50" class="rounded-circle">
                                  <div class=" flex-column ml-2"> <a href="SvDispatchPerfisInfo?id=<%=id%>&tipoPublicacao=<%= tipoPublicacao %>"><span class="font-weight-bold"></span><%= nomeUsuarioEstab %></span></a>
                                      <br>
                                      <small class="text-primary"><%= tipoPublicacao %></small> </div>
                              </div>
                              <div class=" flex-row mt-1 ellipsis"> <small class="mr-2">Data: <%=p.getData()%> &nbsp;&nbsp;&nbsp; Hora: <%=p.getHora()%></small></div>
            ...
            <% List<Comentario> listaComentarios = p.getComentarios();
                ...
                <div class="comments mx-4">
                  <div class=" flex-row mb-2"> <img src="img/perfil.png" width="40" class="rounded-image">
                      <div class=" flex-column ml-2"> <span class="name"><%= usu.getNickName() %></span> <small class="comment-text"><%=c.getComentario()%></small>
                          <div class=" flex-row align-items-center status"> <small><%="Data: " + c.getData() + "&nbsp;&nbsp;&nbsp; Hora: " + c.getHora()%>></small> </div>
                      </div>
                  </div>
                </div>
                        <%
                ...
                <form action="SvCadastraComentario" method="post">
                    ...
                    <button class="btn btn-primary mt-2 ml-2" type="submit">Fazer Comentario</button>
                    </div>
                </form>
