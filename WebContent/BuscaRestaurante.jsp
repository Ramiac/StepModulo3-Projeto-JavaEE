                ...
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                  ...
                  <div class="dropdown text-end">
                    ...
                    <ul class="dropdown-menu text-small" aria-labelledby="dropdownUser1">
                      ...
                      <li><a class="dropdown-item" href="SvBuscaEstabUsuario">Editar um dos seus estabelecimentos</a>
                      </li>
                ...
                <div class="row justify-content-md-center">
                  ...
                  <form>
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                        <button class="btn btn-primary" type="submit" formaction="SvBucaRestauranteNome" formmethod="POST">Procura pelo
                      nome</button>
                      </div>
                    </div>
                  </form>
                  ...
                  <form>
                    ...
                    <input class="form-control" type="text" name="busca" id="cnpj" onblur="ValidaCnpj()" required>
                      ...
                      <div class="col">
                    <button class="btn btn-primary" type="submit" formaction="SvBucaRestauranteCnpj" formmethod="POST">Procura pelo
                      CNPJ</button>
                      </div>  
                    </div>
                  </form>
