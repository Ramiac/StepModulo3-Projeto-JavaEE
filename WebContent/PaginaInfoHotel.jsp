...
<head>
    <meta charset="UTF-8">
    <title>InstaFood - hotel: <%=request.getParameter("nome")%></title>
...
<header class="p-3 mb-3 border-bottom">
    ...
    <main>
        <%
            boolean direito = (boolean) request.getAttribute("direito");
            boolean booking = (boolean) request.getAttribute("booking");
            boolean tripAdvisor = (boolean) request.getAttribute("tripAdvisor");
            boolean agencia = (boolean) request.getAttribute("agencia");
        %>
        <div class="container">
        <h3>Pagina do hotel: <%=request.getAttribute("nome")%></h3>
        <div class="row justify-content-md-center">
            ...
            <ul>
                ...
                <% 
                    if (direito) out.print("<li>Reservação por telefone ou por email.</li>"); 
                    if (agencia) out.print("<li>Reservação atraves de agência de turismo.</li>"); 
                    if (booking) out.print("<li>Delivery pelo <a href='https://www.booking.com' target='_blank' rel='noopener noreferrer'>Booking.com</a></li>"); 
                    if (tripAdvisor) out.print("<li>Delivery pelo <a href='https://www.tripadvisor.com.br/' target='_blank' rel='noopener noreferrer'>Trip Advisor</a></li>"); 
                %>
            </ul>
            <span>Foto principal hotel: </span><img src="img/hotel.jpg" width="100px" height="100px">
            <br>
            </div>
            <div class="col-lg-10">
            <p>Endereços: </p>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <% 
                            ...
                            out.println(
                                "Esse hotel não tem nenhum endereço cadastrado ainda."
                            );
                        } 
                    %>
                </tbody>
