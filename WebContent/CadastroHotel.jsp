...
<head>
<meta charset="UTF-8">
<title>InstaFood - Cadastro de Hotel</title>
...
<header class="p-3 mb-3 border-bottom">
    ...
    <main>
    <div class="container">
    <h2>Cadastra Hotel</h2>
    <div class="row justify-content-md-center">
      <div class="col-lg-6">
        
        <form action="SvCadastraHotel" method="POST" onsubmit="return ValidaHotel()">
          <div class="row g-3">
          <div class="col-sm-12">
            <label class="form-label" for="nome">Nome do Hotel</label>
          ...
          <div class="col-sm-12">
            <label class="form-label" for="imagem">Carrega a foto principal do Hotel: </label>
            <br>
            <img src="img/hotel.jpg" alt="image hotel" id="imagem" width="200" height="200">
          </div>
          <div class="col-sm-12">
          ...
          <div class="col-sm-12">
            ...
            <div class="col">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="opcaoReserva" value="direito" id="direito">
                <label class="form-check-label" for="direito">Contato direito</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="opcaoReserva" value="agencia" id="agencia">
                <label class="form-check-label" for="agencia">Agencia de viagem</label>
              </div>
            </div>
            <div class="col">
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="opcaoReserva" value="booking" id="booking">
                <label class="form-check-label" for="booking">Booking.com</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="checkbox" name="opcaoReserva" value="tripadvisor" id="tripadvisor">
